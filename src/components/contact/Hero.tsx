...
const ContactHero: React.FC = () => {
  return (
    <div
      className="w-full flex flex-row py-20 xs:px-8 md:px-[120px]"
    ...
    >
      <div className="py-8">
        ...
        <p className="opacity-[0.92] text-base md:text-lg lg:text-xl font-medium xs:text-center md:text-left text-white">
          Have questions or feedback? Our team is ready to assist you with any
          questions or support you need. Send us a message, we will respond
          within 24 hours.
        </p>
      </div>
      <div className="flex justify-center items-center w-full md:w-auto h-full">
        <Image
          ...
          className="w-auto h-full max-h-[300px] md:max-h-none"
        />
      </div>
    </div>
  );
