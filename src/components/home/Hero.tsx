...
const Hero: React.FC = () => {
  return (
    <section className="Hero-section">
      <div className="flex flex-col md:justify-start md:items-start gap-[9.5px] space-y-9 xs:py-20 py-52 xs:px-8 px-32">
        ...
        <div className="flex flex-col justify-start items-start self-stretch gap-[38px]">
          <div className="flex flex-col">
            ...
            <p className="self-stretch opacity-[0.96] text-[15.836297988891602px] xs:text-center md:text-left text-black">
              Our solution democratizes football by providing elite-level
              scouting, comprehensive talent development data, and cutting-edge
              information mapping tools to every club. This empowers coaches and
              scouts to identify and nurture talent effectively, bridging the
              gap between grassroots and professional football.
            </p>
          </div>
        </div>
