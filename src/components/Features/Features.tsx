...
const FeaturesPage = () => {
    ...
    return (
        ...
        <div className="bg-primary py-40 relative">
            <div className="flex flex-col gap-4 justify-center items-center text-white">
                <h2 className="font-bold font-merriweather text-4xl w-[650px] text-center">Everything You Need to Succeed in One Platform.</h2>
                <p className="font-lato font-normal text-base w-[620px] text-center">From player scouting to performance tracking and seamless connections—unlock every tool you need to advance your football career in one powerful platform</p>
                <button className="bg-secondary text-black-50 w-[232px] h-[45px] rounded-3xl font-poppins text-sm font-semibold mt-4">
                UNLOCK OPPORTUNITIES
                </button>
            </div>

            <div className="absolute bottom-0 left-0 right-0 h-auto bg-white text-black-50 translate-y-1/2 rounded-[20px] mx-[106px]">
          <div className="px-6 py-6">
            <p className="font-manrope font-semibold text-2xl">How does it work?</p>
            <div className="flex items-center gap-[2px] mt-4">
                ...
                <Image src={Line} className="w-[270px]" alt={""} />
                </div>
                <div className="mt-4">
                    <h2 className="font-lato text-base font-medium">Create Your Profile</h2>
                    <p className="font-lato text-xs font-normal w-[220px] mt-2">Whether you&apos;re a player, coach, or scout, set up a profile to showcase your skills, experience, and goals.</p>
                </div>
                </div>
                <div>
                    <div className="flex items-center gap-[2px] mt-4">
                ...
                <div className="mt-4">
                    ...
                    <p className="font-lato text-xs font-normal w-[220px] mt-2">Players upload match footage and stats, while scouts and coaches browse, track, and evaluate talent.</p>
                </div>
                </div>
                <div>
                    <div className="flex items-center gap-[2px] mt-4">
                ...
                <div className="mt-4">
                    ...
                    <p className="font-lato text-xs font-normal w-[220px] mt-2">Players get discovered, scouts find top talent, and coaches build winning teams through direct messaging.</p>
                </div>
                </div>
                <div>
                    <div className="flex items-center gap-[2px] mt-4">
                ...
                <div className="mt-4">
                    ...
                    <p className="font-lato text-xs font-normal w-[220px] mt-2">From trials to signings, coaching roles, and scouting missions—take your football career to the next level.</p>
                </div>
                </div>
            </div>
          </div>
        ...
        <div className="bg-ghostwhite pt-48"></div>
