    ...
    <div className="w-full xs:bg-inherit md:bg-[#192b4d] shadow-md">
      ...
      {isMenuOpen && (
        <div className="md:hidden xs:bg-inherit md:bg-[#192b4d] px-6 py-4">
          ...
          <Link href={Urls.ABOUT} className={getLinkClass(Urls.ABOUT) + " block"}>
            About
          </Link>
          <Link href={Urls.SERVICES} className={getLinkClass(Urls.SERVICES) + " block"}>
            Services
          </Link>
          <Link href={Urls.BLOGS} className={getLinkClass(Urls.BLOGS) + " block"}>
            Blogs
          </Link>
          <Link href={Urls.CONTACT} className={getLinkClass(Urls.CONTACT) + " block"}>
            Contact
          </Link>
          <Link href={Urls.SIGNUP}>
