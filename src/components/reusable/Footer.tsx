...
const Footer: React.FC = () => {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(179.79deg, rgba(177,207,241,0.48) 0.29%, #fff 133.37%)",
      }}
    >
      <Image
        src={ballImage}
        className="w-full h-auto absolute right-0 top-0 opacity-[0.08] object-cover max-w-full"
        alt=""
      />
        ...
        <div className="flex flex-row justify-around w-full gap-8 px-4 md:px-8 lg:px-16">
          <div className="flex flex-col items-start gap-10 w-full sm:w-auto">
            ...
            <p className="max-w-sm xs:hidden md:flex text-base text-black">
              At ScoutFlair, our mission is to provide football enthusiasts,
              coaches, and analysts with the tools they need to unlock the
              game's hidden insights.
            </p>
          </div>
          <div className="flex flex-col gap-4 w-full sm:w-auto">
            <p className="text-2xl font-semibold text-black">Quick Links</p>
            <div className="flex flex-col gap-4">
              <a href="#about" className="text-xl text-black">
                About
              </a>
              <a href="#services" className="text-xl text-black">
                Services
              </a>
              <a href="#resources" className="text-xl text-black">
                Resources
              </a>
          ...
          <div className="flex xs:hidden md:flex flex-col gap-4 w-full sm:w-auto">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="#privacy" className="text-xl text-black">
                Privacy
              </a>
              <a href="#cookies" className="text-xl text-black">
                Cookies
              </a>
              <a href="#terms" className="text-xl text-black">
